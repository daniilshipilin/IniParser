namespace IniParser.Tests
{
    ...
    public class Tests
    {
        ...
        {
            InitIniParser(nameof(SampleIniSuccessfullyParsed));
        ...
        {
            InitIniParser(nameof(SampleIniHashMatchesPrecomputedHash));
        ...
        {
            InitIniParser(nameof(CheckIfKeyValuesMatch));
        ...
        {
            InitIniParser(nameof(SetKeyValues));
        ...
        {
            InitIniParser(nameof(DeleteKeys));
        ...
        {
            InitIniParser(nameof(CheckNonExistentSection));
        ...
        {
            InitIniParser(nameof(CheckEmptySection));
        ...
        {
            InitIniParser(nameof(CheckSectionWithEmptyKey));
        ...
        private void InitIniParser(string destinationIni)
        {
            try
            {
                ...
                string destinationPath = Path.Combine(TMPDIR, $"{destinationIni}.ini");
