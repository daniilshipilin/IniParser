...
public class Tests
{
    private const string EXAMPLEINISHA256 = "418ff6365eafacaeca0e0f7191ba8f8ab20158503833ba4a8f8c810bee1c1fdf";
    ...
    private const string CASESENSITIVESECTION1 = "CaseSensitiveSection";
    private const string CASESENSITIVESECTION2 = "casesensitivesection";
    ...
    private const string KEY11 = "Key";
    private const string KEY12 = "key";
    ...
    private const string VALUE11 = "Test";
    ...
    public void SampleIniHashMatchesPrecomputedHash()
    {
        ...
        string resultHash = GenerateSHA256String(iniBytes);

        if (EXAMPLEINISHA256.Equals(resultHash))
        {
            Assert.Pass();
        }
    ...
    /// <summary>
    /// Test #9 - Check section and key case sensitivity.
    /// </summary>
    [Test]
    public void CheckSectionAndKeysCaseSensitivity()
    {
        if (VALUE11.Equals(ini.GetValue(CASESENSITIVESECTION1, KEY11)) &&
            VALUE11.Equals(ini.GetValue(CASESENSITIVESECTION1, KEY12)) &&
            VALUE11.Equals(ini.GetValue(CASESENSITIVESECTION2, KEY11)) &&
            VALUE11.Equals(ini.GetValue(CASESENSITIVESECTION2, KEY12)))
        {
            Assert.Pass();
        }
    ...
    /// <summary>
    /// Generates SHA256 hash represented as hex string (lowercase).
    /// </summary>
    private static string GenerateSHA256String(byte[] inputBytes)
    {
